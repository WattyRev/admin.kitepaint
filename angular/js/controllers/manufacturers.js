app.controller("ManufacturersController", [
    "$scope",
    "$rootScope",
    "$state",
    function(scope, root, state) {
        ...
        scope.get_manufacturers = function() {
            ...
            $.ajax({
                type: "GET",
                url: app.apiDomain + "manufacturers.php?get=1",
                dataType: "json",
        ...
        scope.update_manufacturers = function() {
            ...
            for (
                var i = 0;
                i < scope.num_display &&
                i < scope.filtered_manufacturers.length;
                i++
            ) {
                scope.display_manufacturers.push(
                    scope.filtered_manufacturers[i]
                );
            }
        };
